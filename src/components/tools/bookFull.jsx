                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col justify-center border-4 border-primary  p-4 py-20  shadow-2xl bg-white  w-full">
                        <div className={`flex flex-col  justify-between mx-auto py-2 px-10 gap-10 ${etaps == false ? 'block' : 'hidden'}`}>
                            ...
                            <div>
                                ...
                                <select onChange={(e) => handleSuiteChange(e.target.value)} name="Suites" id=" " value={suites} className={`bg-transparent text-center border-b-2 ${validation && !suites ? "border-red-500" : "border-primary" } text-lg pb-1 placeholder:text-2xl text-black focus:outline-none w-full pl-4`} >
                        ...
                        <div className={`flex flex-col w-full justify-between mx-auto py-2 px-10 gap-20 ${etaps == true ? 'block' : 'hidden'}`}>
                            <div>
