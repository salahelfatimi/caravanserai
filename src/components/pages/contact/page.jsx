        ...
        <div>
            <div className=" relative h-[35rem] bg-center flex flex-col text-center items-center justify-center" >
                ...
                <div className=" relative z-20 flex flex-col gap-4 container">
                    ...
                    <p className="text-center text-white mb-8 lg:text-xl">We’d love to hear from you! Whether you have a question, need assistance, or just want to say hello, feel free to reach out to us.</p>
                </div>
            </div>
