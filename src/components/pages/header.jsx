    ...
    return (
        <div className=" overflow-hidden bg-white ">
            <div className="relative">
                ...
                <Image src="/img/header.png" alt="Caravan Serai" title="Caravan Serai" width={1920} height={1080} className="   shadow-2xl header-image object-cover h-screen w-screen object-center" />
                <div className="z-20 flex flex-col w-full md:w-fit items-center  gap-4 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white">
                    <Image src="/img/Logo_single_white.png" height={500} width={500} alt="Caravan Serai" title="Caravan Serai" className=" w-44" />
